 ...
 */
@Entity
@Table(name = "rent", catalog = "Mes_Transports")
public class Rent implements java.io.Serializable {
	...
	public Rent(int idUser, int idVehicle, float totalPrice, Date startDate, Date endDate) {
		this.idUser = idUser;
	...
	public Rent(int idUser, int idVehicle, float totalPrice, Date startDate, Date endDate, String locationIn,
			String locationOut) {
		this.idUser = idUser;
		this.idVehicle = idVehicle;
		this.totalPrice = totalPrice;
